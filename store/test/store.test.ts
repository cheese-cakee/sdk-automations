...
describe("effect journal — the 6.5 crash grid, restated as instance reopening", () => {
    ...
    it("a retry increments a durable attempt counter — the bound survives restart", () => {
        const before = new Store(path);
        before.intent("e1", 1, "create-comment", "2026-07-23T10:00:00.000Z"); // attempt 1, response lost
        before.intent("e1", 1, "create-comment", "2026-07-23T10:01:00.000Z"); // resolver said absent; attempt 2
        before.close(); // crash
