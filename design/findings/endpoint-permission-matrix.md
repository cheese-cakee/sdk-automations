...
| Lock an issue | `PUT /repos/{o}/{r}/issues/{n}/lock` with no body and `Content-Length: 0` | Issues W | not measured | — | untested. GitHub documents 204 and either Issues W or Pull requests W; this platform chooses Issues W. Protocol 6.15 must confirm read-back and repeated calls before adoption | [GitHub REST docs](https://docs.github.com/en/rest/issues/issues#lock-an-issue); protocol 6.15 |
| Unlock an issue | `DELETE /repos/{o}/{r}/issues/{n}/lock` | Issues W | not measured | — | untested. GitHub documents 204 and either Issues W or Pull requests W; protocol 6.15 must confirm read-back and repeated calls before adoption | [GitHub REST docs](https://docs.github.com/en/rest/issues/issues#unlock-an-issue); protocol 6.15 |
